...
class ReportAddtionalScreen extends GetView<ReportLocationController> {
  const ReportAddtionalScreen({super.key});
        ...
        children: [
          ...
          ElevatedButton(
            ...
            style: ButtonStyle(
              ...
              foregroundColor: MaterialStatePropertyAll(Get.theme.primaryColor),
            ),
